...
describe('ProductService safe delete', () => {
  it('archives an existing product', async () => {
    ...
    const service = new ProductService({ product: { findUnique, update } } as any, {} as any, {} as any, { write: jest.fn() } as any)
  ...
  it('rejects deleting a missing product', async () => {
    ...
    const service = new ProductService({ product: { findUnique } } as any, {} as any, {} as any, { write: jest.fn() } as any)
  ...
  it('deduplicates IDs and archives products in one update', async () => {
    ...
    const service = new ProductService({ product: { updateMany } } as any, {} as any, {} as any, { write: jest.fn() } as any)
